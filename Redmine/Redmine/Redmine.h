...
private:
	...
	LRESULT WndProcCreateWindow(HWND, UINT, WPARAM, LPARAM);
	LRESULT WndProcDestroyWindow(HWND, UINT, WPARAM, LPARAM);
	LRESULT WndProcPaint(HWND, UINT, WPARAM, LPARAM);
	LRESULT WndProcInput(HWND, UINT, WPARAM, LPARAM);
	LRESULT WndProcCommand(HWND, UINT, WPARAM, LPARAM);
	LRESULT WndProcTimer(HWND, UINT, WPARAM, LPARAM);
	LRESULT WndProcTrayNotify(HWND, UINT, WPARAM, LPARAM) const;
	LRESULT WndProcUserInfoUpdate(HWND, UINT, WPARAM, LPARAM);
